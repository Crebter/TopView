    ...
    $(document).ready(function(){
        ...
        $("#form1").submit(function(){
            ...
            if(relpassword.length==0){
                $("#relpasswordError").html("确认不能空");
                return false;
            }
            
            if(password!=relpassword){
                $("#relpasswordError").html("密码不匹配");
                return false;
            }
	...
	<div id="registerbox">
		<div id="form">
				<form action="RegisterServlet" method="post" id="form1">
				    ...
				    <h4 align="center">PS:身份证号不能与他人一致</h6>  
				    <hr/>
				    <table align="center">
				    	<tr>
				        	<td>
					        <select  name="type" id="type" >
					        	<option value="Visiter">外邦人</option>
					        	<option value="DragonTrainer">驯龙高手</option>
					        	<option value="DragonMother">龙妈</option>
					        </td>
					        </select>
				     	</tr>
				        <tr>
